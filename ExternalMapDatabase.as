package {
	 ...
	 */
	public class ExternalMapDatabase extends EventDispatcher {
		...
		public function ExternalMapDatabase() {
		}

		public function loadData() {
			tilesetInfo = new Array();
			mapInfo = new Array();
			mapObjectInfo = new Array();
			this.loadObject(mapsURL, handleLoadedMaps);
